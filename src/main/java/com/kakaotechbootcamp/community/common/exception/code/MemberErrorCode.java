...
public enum MemberErrorCode implements ErrorCode {
    ...
    USER_NOT_FOUND(HttpStatus.UNMEMBERIZED, "사용자를 찾을 수 없습니다"),
    INVALID_OR_EXPIRED_TOKEN(HttpStatus.UNMEMBERIZED, "유효하지 않거나 만료된 토큰입니다"),
    INVALID_PASSWORD(HttpStatus.UNMEMBERIZED, "비밀번호가 일치하지 않습니다"),
    INVALID_CURRENT_PASSWORD(HttpStatus.UNMEMBERIZED, "현재 비밀번호가 일치하지 않습니다"),
